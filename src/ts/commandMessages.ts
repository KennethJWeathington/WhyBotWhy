const Messages = {
  RULES:
    'Please remember the channel rules: 1. Be kind 2. No politics or religion 3. No spam 4. Only backseat if I ask for it.',
  WHY: 'Why @{name}, why???',
...
function AssembleTemplatedString(templateString: string, templateArgs: {}) {
...
export { Messages, AssembleTemplatedString };
